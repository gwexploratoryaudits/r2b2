...
if __name__ == '__main__':
    ...
    for r in range (1,max_rounds+1):
        ...
        title = 'Round '+str(r)+' Experimental Absolute Risk (90% Minerva)'
        plt.title(title)
    ...
    plt.xlabel('Reported Margin')
    title = 'Experimental Total Risk (across 5 rounds) (90% Minerva)'
    plt.title(title)
    plt.ylabel('Experimental Risk')
    plt.grid()
    plt.show()
    ...
    plt.xlabel('Reported Margin')
    title = 'Experimental Total Stopping Probability (across 5 rounds) (90% Minerva)'
    plt.title(title)
    ...
    for r in range (1,max_rounds+1):
        ...
        plt.xlabel('Reported Margin')
        title = 'Round '+str(r)+' Experimental Absolute Stopping Probability (90% Minerva)'
        plt.title(title)
        plt.ylabel('Experimental Stopping Probability')
        plt.grid()
        plt.show()
