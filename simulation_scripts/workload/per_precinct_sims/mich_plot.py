...
contest = election.contests['Michigan']
...
simulation_sprob_arg = 'sample_sprob'
sim_args = {'description':'eor bravo workload'}
...
#plt.axvline(x=.95, label='Value in pilot', linestyle='--')
#plt.plot([.95],[140],marker='X',color='k',label='Value 
plt.legend(loc='upper left')
plt.tight_layout()
plt.show() 
