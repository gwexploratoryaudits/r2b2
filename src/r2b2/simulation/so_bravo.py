...
class PerPrecinctSO_BRAVOMultiRoundStoppingProb(Simulation):
    """Simulate a multi-round SO_BRAVO audit.
    ...
    def analyze(self, verbose: bool = False, hist: bool = False):
        ...
        print('asn: '+str(asn)+'(printing from src/r2b2/simulation/so_bravo.py)')
