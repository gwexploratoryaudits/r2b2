"""Generates plots for the 90% sprob multiround SO_BRAVO stopping probability sims."""
...
if __name__ == '__main__':
    ...
    for contest in election.contests:
        ...
        sprob_sim = db.db.simulations.find_one({
            ...
            'underlying': 'reported',
            'audit': audit_id,
            'description': 'Multiround SO_BRAVO (90%) Corrected',
    ...
    for r in range (1,max_rounds+1-2):
        ...
        title = 'Proportion of Audits that Stopped by Round (SO BRAVO, Reported)'
        plt.title(title)
