...
if __name__ == '__main__':
    ...
    for r in range (1,max_rounds+1):
        ...
        title = 'Round '+str(r)+' Experimental Absolute Risk (90% EOR_BRAVO)'
        plt.title(title)
    ...
    plt.xlabel('Reported Margin')
    title = 'Experimental Total Stopping Probability (across 5 rounds) (90% EOR_BRAVO)'
    plt.title(title)
    ...
    for r in range (1,max_rounds+1):
        ...
        plt.xlabel('Reported Margin')
        title = 'Round '+str(r)+' Experimental Absolute Stopping Probability (90% EOR_BRAVO)'
        plt.title(title)
        plt.ylabel('Experimental Stopping Probability')
        plt.grid()
        plt.show()
    ...
    for r in range (1,max_rounds+1):
        ...
        plt.xlabel('Reported Margin')
        title = 'Round '+str(r)+' Conditional Stopping Probability (90% EOR_BRAVO)'
        plt.title(title)
    ...
    for r in range (1,max_rounds+1):
        ...
        plt.xlabel('Reported Margin')
        title = 'Round '+str(r)+' Experimental EOR_BRAVO Ratio (90% EOR_BRAVO)'
        plt.title(title)
        plt.ylabel('Experimental EOR_BRAVO Ratio')
        plt.grid()
        plt.show()
