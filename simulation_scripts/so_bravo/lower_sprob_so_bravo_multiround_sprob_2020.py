...
where each round size is estimated to achieve a 25% probability of stopping.
...
def state_trial(state, alpha):
    ...
    query = {
        ...
        'description' : 'Multiround SO_BRAVO (25%)',
        'max_rounds': 100
    }
    ...
    sim = SBMRSP(alpha,
               ...
               max_rounds=100,
               sample_sprob=.25,
               sim_args={'description': 'Multiround SO_BRAVO (25%)'},
               user='writer',
               pwd='icanwrite',
               reported_args={
                   'name': state,
...
if __name__ == '__main__':
    ...
    if margin < 0.05: # just 10% margins and greater at first
