...
if __name__ == '__main__':
    ...
    for r in range (1,max_rounds+1):
        ...
        title = 'Round '+str(r)+' Experimental Absolute Risk (25% then 1.5x Minerva)'
        plt.title(title)
...
"""
    ...
    plt.xlabel('Reported Margin')
    title = 'Experimental Total Risk (across 5 rounds) (25% then 1.5x Minerva)'
    plt.title(title)
    plt.ylim(.04,.1)
    plt.ylabel('Experimental Risk')
    plt.grid()
    ...
    plt.xlabel('Reported Margin')
    title = 'Experimental Total Stopping Probability (across 5 rounds) (25% then 1.5x Minerva)'
    plt.title(title)
    ...
    for r in range (1,max_rounds+1):
        ...
        plt.xlabel('Reported Margin')
        title = 'Round '+str(r)+' Experimental Absolute Stopping Probability (25% then 1.5x Minerva)'
        plt.title(title)
        plt.ylabel('Experimental Stopping Probability')
        plt.grid()
        plt.show()
    ...
    for r in range (1,max_rounds+1):
        ...
        plt.xlabel('Reported Margin')
        title = 'Round '+str(r)+' Experimental Minerva Ratio (25% then 1.5x Minerva)'
        plt.title(title)
