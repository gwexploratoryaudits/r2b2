...
election = parse_election('data/2020_presidential.json')
sample_size_file = 'data/2020_presidential_one_round_sample_sizes.json'
...
def state_trial(state, alpha, sample_size):
    sim = MORR(alpha,
               ...
               sample_multi = 1.5,
               max_rounds = 10,
               sim_args={'description': 'One round Minerva with given sample size (from PV MATLAB)'},
               reported_args={
                   'name': state,
